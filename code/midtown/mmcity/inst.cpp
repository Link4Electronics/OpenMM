...
void MatrixFromPoints(Matrix34& mat, Vector3& start, Vector3& end, f32 scale)
{
    // Ported from game.asm (mmcity:inst).
    Vector3 dir = end - start;
    const f32 length = dir.Mag() / scale;
    const Vector3 fwd = dir * dir.InvMag();

    mat.m0 = fwd * length;
    mat.m1 = {0.0f, 1.0f, 0.0f};
    mat.m2 = {fwd.z, 0.0f, -fwd.x};
    mat.m3 = start;
